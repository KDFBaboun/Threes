...
def tests_partie1():
    print("Test de la partie 1".center(32, "-"))
    test_init_play()
    test_check_indice()
    test_check_room()
    test_is_room_empty()
...
def tests_partie2():
    print("Test de la partie 2".center(32, "-"))
    test_line_move()
    test_line_pack()
    test_lines_move()
    test_column_move()
...
def tests_partie3():
    print("Test de la partie 3".center(32, "-"))
...
def tests_global():
    ...
    print("Tests unitaires".center(32))
    tests_partie1()
    tests_partie2()
    tests_partie3()
    affiche[platform.system()][0](affiche[platform.system()][1])
    print("Fin des test unitaires".center(32, "-"))
